...
- **Make-private** — `going-private.ts` stops serving and converts any live anchored links from other collections into frozen copies; the slug is kept. (Anchor-less collection-link pointers are excluded from the freeze — see §5.6.)
