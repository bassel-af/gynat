...
**Status**: **Public Tree v1 — ✅ shipped (2026-06-16).** **Collections — Chunks 1–4 ✅ shipped + cleanup pass ✅ done (2026-06-18). Feature fully complete — no outstanding cleanups.** Design decisions for both captured below.
