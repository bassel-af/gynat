...
**Status**: **Public Tree v1 — ✅ shipped (2026-06-16).** **Collections — Chunks 1–4 ✅ shipped (Chunk 4: public collection serving, 2026-06-18). Feature functionally complete; only low-severity cleanups remain (see §5).** Design decisions for both captured below.
