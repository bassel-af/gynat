...
**Status**: **Public Tree v1 — ✅ shipped (2026-06-16).** **Collections — Chunks 1–3 ✅ shipped (2026-06-17); Chunk 4 remaining (public collection serving).** Design decisions for both captured below.
...
2. **Collections** — partially shipped, built in chunks:
   ...
   - **Chunk 4 — NEXT (§2.10).** Public collection serving: its own deny-by-default route, recursive withholding of private/private-sourced items, the serve-time reuse/visibility re-check, the publish-preview "what's withheld" warning, and going-private freeze-repoint (including the deferred collection-link preservation).
