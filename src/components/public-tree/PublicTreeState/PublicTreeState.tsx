...
> = {
  loading: {
    ...
    text: 'لحظات قليلة ريثما نحضر الأجداد.',
  },
  empty: {
    title: 'لا تتوفر معلومات معروضة',
    text: 'هذه الشجرة لا تحتوي حاليا على أفراد معروضين للعموم.',
  },
  unavailable: {
    title: 'هذه الشجرة غير متاحة للعرض حاليا',
    text: 'قد تكون العائلة قد أوقفت عرضها للعموم، أو أن الرابط غير صحيح.',
    showWordmark: true,
  },
};
