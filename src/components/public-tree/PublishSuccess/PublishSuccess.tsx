...
const LEVEL_COPY: Record<Exclude<VisibilityLevel, 'private'>, { title: string; note: string }> = {
  link: {
    ...
    note: 'يستطيع من يملك هذا الرابط مشاهدتها. لا تظهر في نتائج محركات البحث.',
  },
  search: {
    title: 'نشرت شجرتك وقد تظهر في محركات البحث',
    note: 'شارك الرابط الآن. قد تبدأ بالظهور في نتائج محركات البحث مثل Google خلال الأيام القادمة.',
  },
};
