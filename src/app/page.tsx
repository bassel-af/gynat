...
const faqItems = [
  ...
  },
  {
    ...
    a: 'شجرة عائلتك خاصّةٌ بشكلٍ افتراضي ولا تظهر لأحدٍ خارج من تدعوهم أنت. وإن رغبت، يمكنك نشر العوائل التاريخية للعموم في صفحةٍ للقراءة فقط، مع إخفاء بيانات الأحياء حفاظاً على خصوصيتهم وسلامتهم. كما يمكنك تجميع عدّة عوائل في مجموعةٍ واحدة ونشرها معاً.',
  },
  {
          ...
          <div className={styles.featureGrid}>
            ...
            <article className={styles.featureCard}>
              ...
              <p className={styles.cardText}>
                ...
                التشفير. وإن رغبت، يمكنك نشر العوائل التاريخية للعموم
                بخيارٍ اختياريّ.
              </p>
            </article>
