...
const faqItems = [
  ...
  },
  {
    ...
    a: 'شجرة عائلتك خاصّةٌ بشكلٍ افتراضي ولا تظهر لأحدٍ خارج من تدعوهم أنت. وإن رغبت، يمكنك نشر عائلتك للعموم في صفحةٍ للقراءة فقط، مع إخفاء بيانات الأحياء حفاظاً على خصوصيتهم. كما يمكنك تجميع عدّة عائلاتٍ في مجموعةٍ واحدة ونشرها معاً.',
  },
  {
          ...
          <div className={styles.featureGrid}>
            ...
            <article className={styles.featureCard}>
              ...
              <p className={styles.cardText}>
                ...
                التشفير. وإن رغبت، يمكنك نشر العائلات التاريخية للعموم
                بخيارٍ اختياريّ.
              </p>
            </article>
